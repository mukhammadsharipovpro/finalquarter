...
import {europeanFeast} from '../assets/products';

const FinalQuarterCartItemComponent = ({item}) => {
  ...
  const productImage = europeanFeast.find(p => p.name === item.name)?.image;
...
export default FinalQuarterCartItemComponent;
