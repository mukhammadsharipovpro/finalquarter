...
import FinalQuarterCartItemComponent from '../components/FinalQuarterCartItemComponent';
import FinalQuarterComponent from '../components/FinalQuarterComponent';
...
export default function () {
  ...
  const handleOrder = () => {
    const destinationScreen = cart.length
      ? 'FinalQuarterCartSuccessScreen'
      : 'FinalQuarterHomeScreen';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <FinalQuarterCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
